...
export function buildParameterSchema(fieldGroups) {
  const meta = {
    ...
    Fhold: { febioPath: "operation.hold.force", min: 0, max: 1000, description: "Hold force proxy in nN." },
    P_hold: { febioPath: "operation.suction.pressureMagnitude", min: 0, max: 1000, description: "Solver-active suction pressure magnitude in kPa." },
