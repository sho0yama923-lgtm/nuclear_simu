...
OUT_MSH = SCRIPT_DIR / "native-python-api-block.msh"
...
gmsh.model.geo.addPoint(X_n26, Y_n0p5, Z_0, 0, 1)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_0, 0, 2)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_0, 0, 3)
gmsh.model.geo.addPoint(X_n26, Y_0p5, Z_0, 0, 4)
gmsh.model.geo.addPoint(X_n26, Y_n0p5, Z_34, 0, 5)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_34, 0, 6)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_34, 0, 7)
gmsh.model.geo.addPoint(X_n26, Y_0p5, Z_34, 0, 8)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMin, pipetteZBottom, 0, 17)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMin, pipetteZBottom, 0, 18)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMax, pipetteZBottom, 0, 19)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMax, pipetteZBottom, 0, 20)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMin, pipetteZTop, 0, 21)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMin, pipetteZTop, 0, 22)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMax, pipetteZTop, 0, 23)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMax, pipetteZTop, 0, 24)
gmsh.model.geo.addPoint(X_n26, Y_n0p5, Z_n2p72, 0, 25)
gmsh.model.geo.addPoint(X_26, Y_n0p5, Z_n2p72, 0, 26)
gmsh.model.geo.addPoint(X_26, Y_0p5, Z_n2p72, 0, 27)
gmsh.model.geo.addPoint(X_n26, Y_0p5, Z_n2p72, 0, 28)
gmsh.model.geo.addPoint(X_n26, Y_n0p5, Z_0, 0, 29)
gmsh.model.geo.addPoint(X_26, Y_n0p5, Z_0, 0, 30)
gmsh.model.geo.addPoint(X_26, Y_0p5, Z_0, 0, 31)
gmsh.model.geo.addPoint(X_n26, Y_0p5, Z_0, 0, 32)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_0, 0, 33)
gmsh.model.geo.addPoint(X_26, Y_n0p5, Z_0, 0, 34)
gmsh.model.geo.addPoint(X_26, Y_0p5, Z_0, 0, 35)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_0, 0, 36)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_34, 0, 37)
gmsh.model.geo.addPoint(X_26, Y_n0p5, Z_34, 0, 38)
gmsh.model.geo.addPoint(X_26, Y_0p5, Z_34, 0, 39)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_34, 0, 40)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_0, 0, 41)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_0, 0, 42)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_0, 0, 43)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_0, 0, 44)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_8, 0, 45)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_8, 0, 46)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_8, 0, 47)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_8, 0, 48)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_26, 0, 49)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_26, 0, 50)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_26, 0, 51)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_26, 0, 52)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_34, 0, 53)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_34, 0, 54)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_34, 0, 55)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_34, 0, 56)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_n2p72, 0, 57)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_n2p72, 0, 58)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_n2p72, 0, 59)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_n2p72, 0, 60)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_0, 0, 61)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_0, 0, 62)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_0, 0, 63)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_0, 0, 64)
gmsh.model.geo.addPoint(X_n26, Y_n0p5, Z_8, 0, 65)
gmsh.model.geo.addPoint(X_n26, Y_0p5, Z_8, 0, 66)
gmsh.model.geo.addPoint(X_n26, Y_n0p5, Z_26, 0, 67)
gmsh.model.geo.addPoint(X_n26, Y_0p5, Z_26, 0, 68)
gmsh.model.geo.addPoint(X_26, Y_n0p5, Z_8, 0, 69)
gmsh.model.geo.addPoint(X_26, Y_0p5, Z_8, 0, 70)
gmsh.model.geo.addPoint(X_26, Y_n0p5, Z_26, 0, 71)
gmsh.model.geo.addPoint(X_26, Y_0p5, Z_26, 0, 72)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_8, 0, 73)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_8, 0, 74)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_8, 0, 75)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_8, 0, 76)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, Z_26, 0, 77)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, Z_26, 0, 78)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, Z_26, 0, 79)
gmsh.model.geo.addPoint(X_n14, Y_0p5, Z_26, 0, 80)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, pipettePatchZBottom, 0, 81)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, pipettePatchZBottom, 0, 82)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, pipettePatchZBottom, 0, 83)
gmsh.model.geo.addPoint(X_n14, Y_0p5, pipettePatchZBottom, 0, 84)
gmsh.model.geo.addPoint(X_n14, Y_n0p5, pipettePatchZTop, 0, 85)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, pipettePatchZTop, 0, 86)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, pipettePatchZTop, 0, 87)
gmsh.model.geo.addPoint(X_n14, Y_0p5, pipettePatchZTop, 0, 88)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, pipettePatchZBottom, 0, 89)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, pipettePatchZBottom, 0, 90)
gmsh.model.geo.addPoint(pipetteMouthX, Y_n0p5, pipettePatchZTop, 0, 91)
gmsh.model.geo.addPoint(pipetteMouthX, Y_0p5, pipettePatchZTop, 0, 92)
gmsh.model.geo.addPoint(X_26, Y_n0p5, pipettePatchZBottom, 0, 93)
gmsh.model.geo.addPoint(X_26, Y_0p5, pipettePatchZBottom, 0, 94)
gmsh.model.geo.addPoint(X_26, Y_n0p5, pipettePatchZTop, 0, 95)
gmsh.model.geo.addPoint(X_26, Y_0p5, pipettePatchZTop, 0, 96)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMin, pipettePatchZBottom, 0, 97)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMin, pipettePatchZBottom, 0, 98)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMax, pipettePatchZBottom, 0, 99)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMax, pipettePatchZBottom, 0, 100)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMin, pipettePatchZTop, 0, 101)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMin, pipettePatchZTop, 0, 102)
gmsh.model.geo.addPoint(pipetteOuterX, pipetteYMax, pipettePatchZTop, 0, 103)
gmsh.model.geo.addPoint(pipetteMouthX, pipetteYMax, pipettePatchZTop, 0, 104)
